...
export function assetsRouter(projectDir: string): Router {
    const router = Router();
    ...
    router.post('/upload', upload.single('file'), async (req, res) => {
        ...
        const targetDir = (req.body.directory as string) ?? 'models';
...
async function listDir(dir: string, root: string): Promise<FileEntry[]> {
